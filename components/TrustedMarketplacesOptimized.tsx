...
const marketplaces = [
  ...
  { name: 'Google Ads', color: 'from-blue-600 to-indigo-600', logo: '/logos/google-ads.png' },
  { name: 'Meta Ads', color: 'from-blue-500 to-indigo-600', logo: '/logos/meta-ads.png' },
  { name: 'TikTok Shop', color: 'from-pink-500 to-rose-500', logo: '/logos/tiktok-shop.png' },
